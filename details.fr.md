            ...
            <!-- Workflow Orchestration -->
              ...
              <tr>
                ...
                <td class="border border-gray-300 px-4 py-2">
                  ...
                  <span class="text-sm text-gray-600">Airbnb, Mirakl, Coinbase</span>
                </td>
                <td class="border border-gray-300 px-4 py-2 text-center">✔️</td>
                <td class="border border-gray-300 px-4 py-2 text-center">✔️</td>
                <td class="border border-gray-300 px-4 py-2 text-center">✔️</td>
              ...
              <tr>
                ...
                <td class="border border-gray-300 px-4 py-2">
                  <strong>Marimo</strong> <br />
                  <span class="text-sm text-gray-600">Mozilla, Pfizer, Stanford</span>
                </td>
                <td class="border border-gray-300 px-4 py-2 text-center">✔️</td>
                <td class="border border-gray-300 px-4 py-2 text-center">✔️</td>
                <td class="border border-gray-300 px-4 py-2 text-center">✔️</td>
              ...
              <tr>
                ...
                <td class="border border-gray-300 px-4 py-2">
                  <strong>DLT</strong> <br />
                  <span class="text-sm text-gray-600">Hugging Face, SpareBank</span>
                </td>
                <td class="border border-gray-300 px-4 py-2 text-center">✔️</td>
                <td class="border border-gray-300 px-4 py-2 text-center">✔️</td>
                <td class="border border-gray-300 px-4 py-2 text-center">✔️</td>
